...
sql320 = "select date1, ac, sn_o from a320_fault_massages " + \
         "where sn_o is not null and sn_o != '' and sn_o != 'N/A' " + \
         "order by date1 desc"
sql330 = "select date1, ac, sn_o from a330_fault_massages " + \
         "where sn_o is not null and sn_o != '' and sn_o != 'N/A' " + \
         "order by date1 desc"
...
dfexcel = pd.read_excel('E:\\development\\PythonForDataAnalysis\\sql\\input1.xlsx', usecols=[3], dtype=str)
